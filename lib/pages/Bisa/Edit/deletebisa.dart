...
class DeleteRegisterBisaPage extends StatefulWidget {
  const DeleteRegisterBisaPage({Key? key}) : super(key: key);

  @override
  _DeleteRegisterBisaPageState createState() => _DeleteRegisterBisaPageState();
}

class _DeleteRegisterBisaPageState extends State<DeleteRegisterBisaPage> {
  int activeStatus = 0;
