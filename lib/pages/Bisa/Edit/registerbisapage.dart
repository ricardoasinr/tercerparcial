...
class RegisterBisaPage extends StatefulWidget {
  const RegisterBisaPage({Key? key}) : super(key: key);

  @override
  _RegisterBisaPageState createState() => _RegisterBisaPageState();
}

class _RegisterBisaPageState extends State<RegisterBisaPage> {
  int activeStatus = 0;
