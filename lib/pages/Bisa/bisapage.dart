...
import 'package:day33/pages/Bisa/editbisa.dart';
import 'package:day33/pages/doctorespage.dart';
import 'package:day33/pages/profile.dart';
import 'package:flutter/material.dart';

class BisaPage extends StatefulWidget {
  const BisaPage({Key? key}) : super(key: key);

  @override
  _BisaPageState createState() => _BisaPageState();
}

class _BisaPageState extends State<BisaPage> {
  int activeStatus = 0;
                      ...
                      child: IconButton(
                        onPressed: () {
                          Navigator.push(
                             context,
                              MaterialPageRoute(
                                 builder: (context) => DoctoresPage(1)));
                        }, 
                        icon: FadeAnimation(1, Icon(Icons.arrow_forward_ios_outlined , color: Colors.red,)),
                      ),
                    ),
                  )
