...
class RegisterAlianzaPage extends StatefulWidget {
  const RegisterAlianzaPage({Key? key}) : super(key: key);

  @override
  _RegisterAlianzaPageState createState() => _RegisterAlianzaPageState();
}

class _RegisterAlianzaPageState extends State<RegisterAlianzaPage> {
  int activeStatus = 0;
